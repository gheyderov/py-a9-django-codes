...
MIDDLEWARE = [
    ...
    'shop.middleware.GetUserIpsMiddleware',
    'shop.middleware.BlockUserMiddleware'
]
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "account.api.serializers.UserObtainSerializer",
}
...
EMAIL_BACKEND = 'shop.email_backends.EmailBackend'
EMAIL_USE_TLS = True
